    ...
    if (token) {
      setNav(
        <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
          ...
          <li className="nav-item mx-1 my-1">
            <Link href={`/list/recruiter`} passHref legacyBehavior><a className={`nav-link`}>List Perekrut</a></Link>
          </li>
          <li className="nav-item mx-1 my-1">
            <Link href={`/profile/${id}`} passHref legacyBehavior><a className={`nav-link`}>Profile Saya</a></Link>
          </li>
          <li className="nav-item mx-1 my-1">
            <button
